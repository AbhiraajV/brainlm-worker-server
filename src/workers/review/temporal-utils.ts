 ...
 */
export function getLocalDateParts(timezone: string, date: Date = new Date()): {
    year: number;
    month: number;  // 1-12
    day: number;
    hour: number;
 ...
 */
export function getUserLastCompletedWeek(timezone: string): { start: Date; end: Date } | null {
    const now = new Date();
    const local = getLocalDateParts(timezone, now);
 ...
 */
export function getUserLastCompletedMonth(timezone: string): { start: Date; end: Date } | null {
    const now = new Date();
    const local = getLocalDateParts(timezone, now);
 ...
 */
export function hasPeriodCompletedForUser(
 ...
 */
export function getTimezonesAtMidnight(date: Date = new Date()): string[] {
    const midnightTimezones: string[] = [];
 ...
 */
export function getTimezoneScheduleInfo(date: Date = new Date()): {
    timezonesAtMidnight: string[];
    weeklyDue: string[];   // Timezones where it's Monday 00:xx
    monthlyDue: string[];  // Timezones where it's 1st of month 00:xx
} {
    const timezonesAtMidnight: string[] = [];
    const weeklyDue: string[] = [];
    const monthlyDue: string[] = [];
 ...
 */
export function getPeriodKey(reviewType: ReviewType, date: Date): string {
 ...
 */
export function formatDateForReview(date: Date): string {
 ...
 */
export function getPreviousPeriodDate(reviewType: ReviewType, date: Date): Date {
 ...
 */
export function canGenerateReview(reviewType: ReviewType, targetDate: Date): boolean {
    const now = new Date();
 ...
 */
export function parsePeriodKey(periodKey: string): { reviewType: ReviewType; date: Date } | null {
    // Daily: "2024-01-15"
